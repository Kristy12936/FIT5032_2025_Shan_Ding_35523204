...
<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <p>We operate in:{{ topCountries.join(', ') }}</p>
...
// Activity 9b: Get total number of stores
const totalStores = computed(() => bookstores.totalStores)

// Activity 10: Get store types
const storeTypes = computed(() => bookstores.storeTypes)

// Activity 11: Get opening hours
const openingHours = computed(() => bookstores.openingHours)

// Activity 12a: Get list of countries
const topCountries = computed(() => bookstores.countries)

// Activity 12b: Get top seller book
